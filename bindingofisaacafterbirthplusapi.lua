  ...
  Room = {
    ...
    childs = {
      ...
      GetRenderSurfaceTopLeft = {
        type = "method",
        description = "The position the floor and wall textures will be rendered at.",
        args = "()",
        returns = "(Vector)",
        valuetype = "Vector"
      },
      GetRenderScrollOffset = {
        type = "method",
        description = "The camera scroll offset and screen shake offsets are both represented here.",
        args = "()",
        returns = "(Vector)",
        valuetype = "Vector"
      },
      ...
      WorldToScreenPosition = {
        type = "method",
        description = "Converts an entity position to one that can be used to render to the screen.",
...
return {
  ...
  onUnRegister = function(self)
    ide:RemoveAPI("lua", "bindingofisaacafterbirthplusapi")
    ide:RemoveInterpreter("bindingofisaacafterbirthplusapi")
  end,
}